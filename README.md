...
- **JoyLTX25_Take_PLUS / JoyLTX25_Multishot_PLUS** — the same two canvases with four more lanes:
  ...
  and voice carry into every later shot), **Story Source** (one panel: your premise, a file of story ideas walked one per queue, or finished shot prompts — with file dropdowns), **Refs by Name** casting, **LoRA stack** and **audio export**, and **audio
