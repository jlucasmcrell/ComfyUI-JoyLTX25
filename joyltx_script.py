...
class JoyLTX_Script:
    ...
    RETURN_NAMES = ("shots_script", "ltx_prompt", "shot_count")
    FUNCTION = "split"
    CATEGORY = "JoyLTX"
    ...
    def split(self, script, ltx_shot_label="Then, without moving the camera,"):
        ...
        print("[JoyLTX Script]: %d shot(s); scene block %s; "
...
NODE_CLASS_MAPPINGS = {"JoyLTX_Script": JoyLTX_Script}
NODE_DISPLAY_NAME_MAPPINGS = {"JoyLTX_Script": "JoyLTX Script (writer shots -> one LTX prompt)"}
